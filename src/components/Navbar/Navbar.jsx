    ...
    <div className='navbar'>
        ...
        <ul ref={menuRef} className='nav-menu'>
          <img src={menu_close} onClick={closeMenu}className='nav-mob-close'/>
            ...
            <li><AnchorLink className='anchor-link' offset={50} href='#about-skills'><p onClick={()=>setMenu("about-skills")}>Explore my Experience</p></AnchorLink>{menu==="about-skills"?<img src={underline} alt=''/>:<></>}</li>
